  ...
  return (
    <footer className="border-t border-white/10 bg-[#072534] text-white">
      <section className="container mx-auto px-4 py-12 text-center">
        <h3 className="text-3xl md:text-4xl font-extrabold text-[#FFC300]">{t('ctaTitle')}</h3>
      ...
      <div className="container mx-auto grid gap-8 px-4 py-10 md:grid-cols-3">
        <div>
          ...
          <p className="mt-2 text-[#FFC300] font-semibold">{t('footerSlogan')}</p>
        </div>

        <div>
          <h4 className="font-semibold mb-3 text-white">{t('quickLinks')}</h4>
          <ul className="space-y-2 text-white/80">
            <li>
              <Link href="/">{t('home')}</Link>
            </li>
            <li>
              <Link href="/come-funziona">{t('howItWorks')}</Link>
            </li>
            <li>
              <Link href="/chi-siamo">{t('whoWeAre')}</Link>
            </li>
            <li>
              <Link href="/compenso">{t('compensation')}</Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-white/80">
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:info@giustiziainvolo.it">{t('contactEmail')}</a>
            </li>
            <li className="flex items-center gap-2">
