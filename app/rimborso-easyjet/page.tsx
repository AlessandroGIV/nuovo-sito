...
export const metadata: Metadata = {
  title: 'Rimborso Volo easyJet Cancellato | Fino a €600 – Giustizia In Volo',
  description:
    'easyJet ha cancellato il tuo volo? Nessun costo anticipato. Paghiamo solo se otteniamo il rimborso.',
}
...
const steps = [
  ...
  },
  {
    ...
    description:
      'Un nostro legale analizza la situazione e contatta easyJet per tuo conto. Nessun costo anticipato.',
  },
  {
    n: '3',
...
export default function RimborsoEasyJetPage() {
  return (
    <main className="bg-[#072534] text-white">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-[#FFC300] text-3xl md:text-5xl font-extrabold leading-tight max-w-3xl mx-auto">
          Il tuo volo easyJet è stato cancellato o in ritardo? Ecco cosa ti spetta.
        </h1>
        <p className="mt-5 text-white/85 max-w-2xl mx-auto text-lg">
          Il Regolamento CE 261/2004 obbliga easyJet a risarcirti. Noi ci occupiamo di tutto:
          nessun costo anticipato, nessuna burocrazia. Paghiamo solo se otteniamo il rimborso.
        </p>
        <Link
          href="/richiesta"
