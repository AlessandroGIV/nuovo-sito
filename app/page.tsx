  ...
  return (
    <main className="bg-[#072534]">
      ...
      <section className="relative">
        <div className="container mx-auto grid items-start gap-8 px-4 md:py-16 lg:py-20 lg:grid-cols-2 leading-4 py-1">
          {/* Testi a sinistra */}
          <div className="max-w-2xl leading-4 py-0">
            ...
            <p className="text-white text-xl md:text-2xl font-semibold mt-1">{t('heroSubtitle')}</p>
            <p className="text-white/90 text-lg md:text-xl py-0 mt-1">
              {t('heroAmount')}
            </p>
