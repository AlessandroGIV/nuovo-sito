...
export const metadata: Metadata = {
  title: 'Rimborso Volo Iberia Cancellato | Fino a €600 – Giustizia In Volo',
  description:
    'Iberia ha cancellato o ritardato il tuo volo? Recupera fino a €600 di indennizzo. No win, no fee: nessun rischio per te.',
}
...
const steps = [
  ...
  },
  {
    ...
    description:
      'Un nostro legale analizza la situazione e contatta Iberia per tuo conto. Nessun anticipo richiesto.',
  },
  {
    n: '3',
...
export default function RimborsoIberiaPage() {
  return (
    <main className="bg-[#072534] text-white">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-[#FFC300] text-3xl md:text-5xl font-extrabold leading-tight max-w-3xl mx-auto">
          Il tuo volo Iberia è stato cancellato o in ritardo? Ecco a quanto hai diritto.
        </h1>
        <p className="mt-5 text-white/85 max-w-2xl mx-auto text-lg">
          Il Regolamento CE 261/2004 obbliga Iberia a risarcirti. Noi ci occupiamo di tutto:
