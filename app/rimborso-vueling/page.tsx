...
export const metadata: Metadata = {
  title: 'Rimborso Volo Vueling Cancellato | Fino a €600 – Giustizia In Volo',
  description:
    'Vueling ha cancellato o ritardato il tuo volo? Recupera fino a €600 senza rischi. Nessun costo se non ottieni nulla.',
}
...
const steps = [
  ...
  },
  {
    ...
    description:
      'Un nostro legale analizza la situazione e contatta Vueling per tuo conto. Nessun anticipo richiesto.',
  },
  {
    n: '3',
...
export default function RimborsoVuelingPage() {
  return (
    <main className="bg-[#072534] text-white">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-[#FFC300] text-3xl md:text-5xl font-extrabold leading-tight max-w-3xl mx-auto">
          Il tuo volo Vueling è stato cancellato o in ritardo? Ecco cosa ti spetta.
        </h1>
        <p className="mt-5 text-white/85 max-w-2xl mx-auto text-lg">
          Il Regolamento CE 261/2004 obbliga Vueling a risarcirti. Noi ci occupiamo di tutto:
          nessun anticipo, nessuna burocrazia. Nessun costo se non ottieni nulla.
        </p>
        <Link
          href="/richiesta"
