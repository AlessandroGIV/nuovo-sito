...
export const metadata: Metadata = {
  title: 'Rimborso Volo ITA Airways Cancellato | Fino a €600 – Giustizia In Volo',
  description:
    'ITA Airways ha cancellato o ritardato il tuo volo? Hai diritto fino a €600. No win, no fee: paghiamo solo se otteniamo il tuo rimborso.',
}
...
const steps = [
  ...
  },
  {
    ...
    description:
      'Un nostro legale analizza la situazione e contatta ITA Airways per tuo conto. Nessun anticipo richiesto.',
  },
  {
    n: '3',
...
export default function RimborsoItaAirwaysPage() {
  return (
    <main className="bg-[#072534] text-white">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-[#FFC300] text-3xl md:text-5xl font-extrabold leading-tight max-w-3xl mx-auto">
          Il tuo volo ITA Airways è stato cancellato o in ritardo? Hai diritto fino a €600.
        </h1>
        <p className="mt-5 text-white/85 max-w-2xl mx-auto text-lg">
          Il Regolamento CE 261/2004 obbliga ITA Airways a risarcirti. Noi ci occupiamo di tutto:
