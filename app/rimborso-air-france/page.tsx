...
export const metadata: Metadata = {
  title: 'Rimborso Volo Air France Cancellato | Fino a €600 – Giustizia In Volo',
  description:
    'Air France ha cancellato o ritardato il tuo volo? Ottieni fino a €600 di indennizzo. Nessun anticipo, paghiamo solo se vinciamo.',
}
...
const steps = [
  ...
  },
  {
    ...
    description:
      'Un nostro legale analizza la situazione e contatta Air France per tuo conto. Nessun anticipo richiesto.',
  },
  {
    n: '3',
...
export default function RimborsoAirFrancePage() {
  return (
    <main className="bg-[#072534] text-white">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-[#FFC300] text-3xl md:text-5xl font-extrabold leading-tight max-w-3xl mx-auto">
          Il tuo volo Air France è stato cancellato o in ritardo? Recupera fino a €600.
        </h1>
        <p className="mt-5 text-white/85 max-w-2xl mx-auto text-lg">
          Il Regolamento CE 261/2004 obbliga Air France a risarcirti. Noi ci occupiamo di tutto:
          nessun anticipo, nessuna burocrazia. Paghiamo solo se vinciamo.
        </p>
        <Link
          href="/richiesta"
